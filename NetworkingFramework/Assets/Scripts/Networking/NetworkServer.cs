...
public class NetworkServer : MonoBehaviour {
	...
	protected virtual void ConfirmAccepted(Socket clientSocket) {
		...
		clientSocket.Send(PacketHandler.Create(MessageType.ConfirmConnect, clients[clientSocket].clientID, clients[clientSocket].clientName));
		BroadcastMessage(PacketHandler.Create(MessageType.Connected, clients[clientSocket].clientID, clients[clientSocket].clientName), clientSocket);
	}
